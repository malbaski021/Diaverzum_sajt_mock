...
export default function NewsSlider({ articles }: Props) {
  ...
  return (
    <div
      className="relative bg-white rounded-2xl overflow-hidden shadow-sm border border-brand-gray-mid"
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 min-h-[360px]">
        ...
        <div className="flex flex-col justify-between p-8">
          <div>
            ...
            <Link
              ...
              className="inline-flex items-center gap-1 text-brand-blue font-semibold text-sm mt-6 hover:underline"
            >
              Pročitaj više
        ...
        {/* Right — image */}
        <div className="relative bg-brand-blue-light min-h-[240px]">
          {article.image ? (
            <Img
              src={article.image}
              alt={article.title}
